...
from sklearn.linear_model import LinearRegression # We are using Linear Regression for this project
...
model_pipeline = Pipeline([
    ...
    ('regressor', LinearRegression()) # Using Linear Regression as planned
])
